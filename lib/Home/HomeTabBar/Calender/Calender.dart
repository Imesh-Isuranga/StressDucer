...
import 'package:stress_ducer/Home/HomeTabBar/Calender/calenderHelp.dart';
                          ...
                          child: Container(
                            ...
                            child: Center(
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text(number.toString(),style: GoogleFonts.roboto(fontWeight: FontWeight.w300, fontSize: screenWidth*0.05,color: const Color.fromARGB(255, 255, 255, 255)),),
                                  if (!isValidNumber)
                                    Icon(Icons.clear,color: const Color.fromARGB(255, 255, 77, 77),size: screenWidth*0.07,),
