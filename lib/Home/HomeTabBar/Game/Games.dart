...
import 'package:stress_ducer/Home/HomeTabBar/Game/gameHelp.dart';
...
class _GamesState extends State<Games> {
  static Color color = const Color.fromARGB(255, 11, 96, 208);
                                ...
                                if(state == 2)SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(
                                        ...
                                        shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(20))),
                                    child: Text("Back",style: GoogleFonts.roboto(fontSize: screenWidth * 0.033,fontWeight: FontWeight.w600,color: Colors.white),),
                                  ),
                                ),
                        ],
                      ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        //  Image.asset("assets/cardGame.jpg",width: MediaQuery.of(context).size.width*0.5,height: MediaQuery.of(context).size.width*0.5),
                          Text("This is simple Game Develop for Mind Relax",style: GoogleFonts.roboto(fontSize: screenWidth*0.034,fontWeight: FontWeight.w400),textAlign: TextAlign.center,),
                        SizedBox(height: screenHeight*0.2,),
                        SizedBox(
                          ...
                          child: ElevatedButton(
                                      ...
                                      child: Text("Play Now",style: GoogleFonts.roboto(fontSize: screenWidth * 0.029,fontWeight: FontWeight.w600,color: Colors.white),),
                                    ),
                        )
                      ]),
                    ),
