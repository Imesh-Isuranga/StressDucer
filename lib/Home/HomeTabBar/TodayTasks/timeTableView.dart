  ...
  List<String> studentSubjectsList,
    ...
    for (int i = 0; i < dayList[0].length; i++) {
      Map<String, dynamic> tableEntry = {
        'Monday': i < dayList[0].length
            ? dayList[0][i]
            : "null",
        'Tuesday': i < dayList[1].length
            ? dayList[1][i]
            : "null",
        'Wednesday': i < dayList[2].length
            ? dayList[2][i]
            : "null",
        'Thursday': i < dayList[3].length
            ? dayList[3][i]
            : "null",
        'Friday': i < dayList[4].length
            ? dayList[4][i]
            : "null",
        'Saturday': i < dayList[5].length
            ? dayList[5][i]
            : "null",
        'Sunday': i < dayList[6].length
            ? dayList[6][i]
            : "null",
      };
